...
from .contract_forecasting_service import CMIC_HEADERS, cc_list, compute_row, Q, get_db_connection
...
def verify(project_id):
    ...
    try:
        ...
        # Formula identities per CMiC requirements
        for ln in lines:
            checks += [
                ...
                {"label": f"{ln.cost_code}: H == F - Advanced SCOs (≥0)", "ok": ln.H_ctc_unposted >= Q(0) and ln.H_ctc_unposted <= ln.F_adj},
